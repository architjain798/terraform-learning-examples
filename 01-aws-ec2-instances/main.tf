# Dynamic instance configurations based on environment
locals {
  instance_configurations = {
    MY_EC2_1 = {
      instance_type    = "t2.micro"
      root_volume_size = var.environment == "prod" ? 20 : var.ec2_default_root_storage_size
      throughput       = 125
      iops             = 3000
    ...
    MY_EC2_2 = {
      ...
      root_volume_size = var.environment == "prod" ? 30 : var.ec2_default_root_storage_size
      throughput       = 125
      iops             = 3000
